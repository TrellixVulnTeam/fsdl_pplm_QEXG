...
def create_chapter(conn, chapter):
    """
...
for i,file_name in enumerate(files):
    ...
    if '-00.htm' in file_name:
        ...
        if write_data:
            create_chapter(conn, (chapter_number, chapter_name))
    ...
    if len(matches)==1:
        ...
        if write_data:
            create_section(conn, (chapter_number, section_number, section_title))
    ...
    if len(matches)==1:
        ...
        for data_split in data_splits:
            ...
            if len(data_block)>1:
                ...
                if write_data:
                    create_text(conn, (chapter_number, section_number, tradition, location, text))
